/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 2aae98d9544f0459b877bd826ad10721)
// Runtime types generated with workerd@1.20260415.1 2026-04-17 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('../.svelte-kit/cloudflare/_worker');
		durableNamespaces: 'BoothRoom';
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		...
		BOOTH_ROOM: DurableObjectNamespace /* BoothRoom */;
	}
}
